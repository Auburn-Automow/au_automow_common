...
Automow_EKF::Automow_EKF() {
    ...
    states_file << "e,n,t,rl,rr,wb,E,N,T,P00,P01,...,P66" << std::endl;
    models_file.open("/Users/william/data/models.csv");
    models_file << "F00,F01,...,F66,G00,G01,...,G66" << std::endl;
    ahrs_file.open("/Users/william/data/ahrs.csv");
    ahrs_file << "measurement,measurement_wrapped,prediction,innovation,innovation_wrapped,S,Sinv,K1,K2,K3,K4,K5,K6,K7" << std::endl;
